...
def RepresentateALLState(
    state_matrix: np.ndarray,
    oxygen_matrix: np.ndarray,
    fig,
    ax,
...
def Plot_paneles(
    ...
    col_indices_y: list,
    save_path: str,
    global_tittle: str = None,  # type: ignore
    titles: Optional[list] = None,
    eje_x: Optional[list] = None,
    eje_y: Optional[list] = None,
    log_scale: Optional[list] = None,
) -> None:  # type: ignore
    ...
    if num_plots == 1:
        ...
        fig, axes = plt.subplots(
            nrows=(num_plots + 1) // 2, ncols=2
        )  # Hasta 4 gráficos, 2x2 como máximo
